export const lightTheme = {
  ...
  enduranceColorSecondary: "#1a8a52",
  flexibilityColorSecondary: "#3f3480",
  balanceColorSecondary: "#1f3578",
  strengthGradient: "linear-gradient(to right, #000000, #FF5A5F)",
  enduranceGradient: "linear-gradient(to right, #000000, #35d586)",
  flexibilityGradient: "linear-gradient(to right, #000000, #9689e7)",
  balanceGradient: "linear-gradient(to right, #000000, #4169E1)",
...
export const darkTheme = {
  ...
  strengthGradient: "linear-gradient(to right, #000000, #FF5A5F)",
  enduranceGradient: "linear-gradient(to right, #000000, #3CB371)",
  flexibilityGradient: "linear-gradient(to right, #000000, #9370DB)",
  balanceGradient: "linear-gradient(to right, #000000, #1E90FF)",
